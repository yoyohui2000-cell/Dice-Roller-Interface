...
%%PLAYER_UPDATE:{"name":"[角色完整名稱]","hpChange":[整數或null],"conditionsAdd":["狀態"],"conditionsRemove":["狀態"],"inventoryAdd":[{"name":"物品名","qty":數量}],"inventoryRemove":["物品名"],"spellSlotsUse":[{"level":環級,"count":數量}]}%%
...
範例（玩家受傷並中毒）：
%%PLAYER_UPDATE:{"name":"勇者小明","hpChange":-8,"conditionsAdd":["中毒"],"conditionsRemove":[],"inventoryAdd":[],"inventoryRemove":["治癒藥水"],"spellSlotsUse":[]}%%
